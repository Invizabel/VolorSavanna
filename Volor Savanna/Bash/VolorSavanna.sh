...
function hunter()
{
    ...
    if [ "$hunter_list_9" == "1" ] && [ "$rand" == "1" ]; then
        clear
        printf "Unfortunately, you don't escape.\nThey kill you on the spot with a feather.\n" + death_level
        read -p "" hunter_list_9
        volor_savanna_original
    fi
    ...
    if [ "$hunter_list_10" == "1" ]; then
        the_mighty_lion
    fi

    if [ "$hunter_list_10" == "2" ]; then
        clear
...
function the_mighty_lion()
{
    ...
    if [ "$the_mighty_lion_list_2" == "2" ]; then
        clear
        ...
        read -p "" the_mighty_lion_list_4
    fi

    if [ "$the_mighty_lion_list_3" == "1" ]; then
        the_mighty_lion_terrain
    fi

    if [ "$the_mighty_lion_list_3" == "2" ]; then
        clear
        printf "You have chosen not to drink from the river.\nYour fellow warriors have.\nThe river doesn't make them sick because the river comes from a far off glacier.\nUnfortunately, you cross the river and find no more water sources.\nYou die from dehydration.\n" + death_level
        read -p "" the_mighty_lion_list_3
        volor_savanna_original
    fi

    if [ "$the_mighty_lion_list_4" == "1" ]; then
        clear
        printf "You have chosen to kill the zebras.\nBecause you have chosen to do this you don't go hungry.\nNight falls.\nDo you sleep on the ground or in a tree?\n\n1- Ground; 2- Tree\nMake your choice $name:\n"
        read -p "" the_mighty_lion_list_5
    fi

    if [ "$the_mighty_lion_list_4" == "2" ]; then
        clear
        printf "You have chosen not to kill the zebras.\nUnfortunately, because of this, you starve.\n" + death_level
        read -p "" the_mighty_lion_list_4
        volor_savanna_original
    fi

    if [ "$the_mighty_lion_list_5" == "1" ]; then
        clear
        printf "You have chosen to sleep on the ground.\nUnfortunately, a dingo comes up and gobbles you up.\n" + death_level
        read -p "" the_mighty_lion_list_5
        volor_savanna_original
    fi

    if [ "$the_mighty_lion_list_5" == "2" ]; then
        clear
        printf "You have chosen to sleep in a tree.\nNo animals eat you.\nYou see a river.\nDo you drink from it?\n\n1- Yes; 2- No\nMake your choice $name:\n"
        read -p "" the_mighty_lion_list_6
    fi

    if [ "$the_mighty_lion_list_6" == "1" ]; then
        the_mighty_lion_terrain
    fi

    if [ "$the_mighty_lion_list_6" == "2" ]; then
        clear
        printf "You have chosen not to drink from the river.\nYour fellow warriors have.\nThe river doesn't make them sick because the river comes from a far off glacier.\nUnfortunately, you cross the river and find no more water sources.\nYou die from dehydration.\n" + death_level
        read -p "" the_mighty_lion_list_6
        volor_savanna_original
...
function the_mighty_lion_terrain()
{
    rand=$(( $RANDOM % 2 + 1 ))
    
    clear
    
    printf "You have chosen to drink from the river.\nLuckily, the water doesn't have any diseases or viruses.\nYou are full.\nYou need to cross the river.\nHowever, the river is very deep.\nYou could make a temporary bridge but that would kill vital time to hunt The Mighty Lion.\nThe fastest way to cross the river is to make a raft.\nWhat do you do?\n\n1- Make a bridge; 2- Build a raft\nMake your choice $name:\n"
    read -p "" the_mighty_lion_terrain_list_1

    if [ "$the_mighty_lion_terrain_list_1" == "1" ]; then
        clear
        printf "You have chosen to make a bridge.\nYour patience pays off and you get across the river in no time!\nThe path splits in two.\nDo you travel through the hills or the extreme hills?\n\n1- Hills; 2- Extreme hills\nMake your choice $name:\n"
        read -p "" the_mighty_lion_terrain_list_2
    fi

    if [ "$the_mighty_lion_terrain_list_1" == "2" ]; then
        clear
        printf "You have chosen to build a raft.\nUnfortunately, the river brings you to the rapids before you are able to reach the other side.\nThe rapids are heading towards a waterfall, so you panic.\nYou throw your paddle into the river.\nYou fall down the waterfall and hit the rocks at the bottom.\nYour head splits open and you die!\n" + death_level
        read -p "" the_mighty_lion_terrain_list_1
        volor_savanna_original
    fi

    if [ "$the_mighty_lion_terrain_list_2" == "1" ]; then
        clear
        printf "You have chosen to go through the hills.\nYou travel through the hills and see The Mighty Lion!\nWhat weapon do you want to use?\n\n1- Knife; 2- Bow and arrows; 3- Spear; 4- Gun\nMake your choice $name:\n"
        read -p "" the_mighty_lion_terrain_list_3
    fi

    if [ "$the_mighty_lion_terrain_list_2" == "2" ]; then
        clear
        printf "You have chosen to go through the extreme hills.\nYou freeze to death.\n" + death_level
        read -p "" the_mighty_lion_terrain_list_2
        volor_savanna_original
    fi

    if [ "$the_mighty_lion_terrain_list_3" == "1" ]; then
        clear
        printf "You have chosen to use your trusty knife to kill The Mighty Lion!\nSo, $name do you kill The Mighty Lion?\n\n1- Find out!\n"
        read -p "" the_mighty_lion_terrain_list_4
    fi

    if [ "$the_mighty_lion_terrain_list_3" == "2" ]; then
        clear
        printf "You have chosen to use your mighty bow and arrows to kill The Mighty Lion!\nSo, $name do you kill The Mighty Lion?\n\n1- Find out!\n"
        read -p "" the_mighty_lion_terrain_list_4
    fi

    if [ "$the_mighty_lion_terrain_list_3" == "3" ]; then
        clear
        printf "You have chosen to use your powerful spear to kill The Mighty Lion.\nSo, $name do you kill The Mighty Lion?\n\n1- Find out!\n"
        read -p "" the_mighty_lion_terrain_list_4
    fi

    if [ "$the_mighty_lion_terrain_list_3" == "4" ]; then
        clear
        printf "You have chosen to use your overpowered gun to kill The Mighty Lion.\nUnfortunately, your gun explodes in your face.\nYou die.\n" + death_level
        read -p "" the_mighty_lion_terrain_list_3
        volor_savanna_original
    fi

    if [ "$the_mighty_lion_terrain_list_4" == "1" ] && [ "$rand" == "1" ]; then
        clear
        printf "You do not kill The Mighty Lion.\nUnfortunately, The Mighty Lion eats you!\n" + death_level
        read -p "" the_mighty_lion_terrain_list_4
        volor_savanna_original
    fi
...
function warrior()
{
    ...
    printf "You have chosen to be a warrior!\nDo you want to go hunt The Mighty Lion or stay put?\n\n1- Hunt The Mighty Lion; 2- Stay put\nMake your choice $name:\n"
    read -p "" warrior_list_1

    if [ "$warrior_list_1" == "1" ]; then
        the_mighty_lion
    fi

    if [ "$warrior_list_1" == "2" ]; then
        clear
...
function crafter()
{
    ...
    if [ "$crafter_list_5" == "1" ] && [ "$rand" == "2" ]; then
        clear
        printf "You don't escape.\nThey kill you on the spot.\n" + death_level
        read -p "" crafter_list_5
        volor_savanna_original
    fi
...
function farmer()
{
    ...
    if [ "$farmer_list_6" == "2" ]; then
        clear
        printf "You have chosen not to sell your surplus cotton.\nUnfortunately, a wizard says some magic words that make you vanish.\nYou are never seen again.\n" + death_level
        read -p "" farmer_list_6
        volor_savanna_original
    fi
}

function medicine_person()
{
    rand=$(( $RANDOM % 2 + 1 ))
    
    clear
    
    printf "You have chosen to be a medicine person!\nA man is very sick with a fever.\nWhat do you want to do?\n1- Not do anything; 2- Wash him\nMake your choice $name:\n"
    read -p "" medicine_person_list_1

    if [ "$medicine_person_list_1" == "1" ]; then
        clear
        printf "You have chosen not to do anything.\nUnfortunately, the man dies.\nThe man's family is very angry at you.\nYou are tried for murder.\nYou have been found guilty.\nSo you are put to death.\n" + death_level
        read -p "" medicine_person_list_1
        volor_savanna_original
    fi

    if [ "$medicine_person_list_1" == "2" ]; then
        clear
        printf "You have chosen to wash him.\nThe man recovers from his fever.\nYou are a hero in your village.\nThe chief rewards you with a big meal.\nThe chief offers you a week off.\nWhat do you do?\n1- Take a week off; 2- Tend to more sick people\nMake your choice $name:\n"
        read -p "" medicine_person_list_2
    fi

    if [ "$medicine_person_list_2" == "1" ]; then
        clear
        printf "You have chosen to take a week off.\nYou come back and someone is very sick.\nYou are low on herbs.\nDo you go gather more herbs for your remedies or heal the patient with what you have?\n1- Go gather more herbs; 2- Heal the patient\nMake your choice $name:\n"
        read -p "" medicine_person_list_3
    fi

    if [ "$medicine_person_list_2" == "2" ]; then
        clear
        printf "You have chosen to tend to more sick people.\nYou are very good at your craft.\nYou heal most of the people.\nHowever, you are low on herbs.\nDo you go gather some more herbs or tend to a couple more patients?\n1- Go gather more herbs; 2- Go tend to a couple more patients\nMake your choice $name:\n"
        read -p "" medicine_person_list_4
    fi

    if [ "$medicine_person_list_3" == "1" ]; then
        clear
        printf "You have chosen to go gather more herbs.\nBecause of this the patient dies!\nYou are tried for murder.\nAre you found guilty?\n1- Find out!\nMake your choice $name:\n"
        read -p "" medicine_person_list_5
    fi

    if [ "$medicine_person_list_3" == "2" ]; then
        clear
        printf "You have chosen to heal the patient.\nLuckily, you have enough herbs to heal the patient.\nYou need to gather more herbs.\nYou go gather some more herbs.\nWhile gathering more herbs you find a signal that says: \"S.O.S. >\"\nWhat do you do?\n1- Go investigate the distress signal; 2- Ignore it; 3- Go back to my tribe and tell someone about it\nMake your choice $name:\n"
        read -p "" medicine_person_list_6
    fi

    if [ "$medicine_person_list_4" == "1" ]; then
        clear
        printf "You have chosen to gather more herbs.\nYou go gather more herbs.\nLuckily, none of the patients die and you heal all of them.\nWhile gathering more herbs you find a signal that says: \"S.O.S. >\"\n1- Go investigate the distress signal; 2- Ignore it; 3- Tell someone about it\nWhat do you do?\nMake your choice $name:\n"
        read -p "" medicine_person_list_7
    fi

    if [ "$medicine_person_list_4" == "2" ]; then
        clear
        printf "You have chosen to go tend to a couple more patients.\nYou run out of herbs so you go gather more herbs.\nUnfortunately, while gathering herbs, all your patients die!\nYou are tried for murder.\nYou are found guilty.\nHow do you want to be executed?\n1- Arrows; 2- Sword; 3- Flying lawnmower; 4- Musket; 5- Bob the Blobfish\nMake your choice $name:\n"
        read -p "" medicine_person_list_8
    fi

    if [ "$medicine_person_list_5" == "1" ] && [ "$rand" == "1" ]; then
        clear
        printf "Unfortunately, you have been found guilty.\nHow do you want to be executed?\n1- Arrows; 2- Sword; 3- Stoned; 4- Knife; 5- Gun\nMake your choice $name:\n"
        read -p "" medicine_person_list_9
    fi

    if [ "$medicine_person_list_5" == "1" ] && [ "$rand" == "2" ]; then
        clear
        printf "You are not found guilty.\nSome white men come to your tribe.\nThey're asking you if they can settle near you.\nDo you want them to settle near you?\n1- Yes; 2- No\nMake your choice $name:\n"
        read -p "" medicine_person_list_10
    fi

    if [ "$medicine_person_list_6" == "1" ] || [ "$medicine_person_list_7" == "1" ]; then
        clear
        printf "You have chosen to go investigate the distress signal.\nUnfortunately, you get eaten by a pack of dingos.\n" + death_level
        read -p "" medicine_person_list_6
        volor_savanna_original
    fi

    if [ "$medicine_person_list_6" == "2" ] || [ "$medicine_person_list_7" == "2" ]; then
        clear
        printf "You have chosen to ignore it.\nUnfortunately, on your way back you get eaten by a cheetah.\n" + death_level
        read -p "" medicine_person_list_6
        volor_savanna_original
    fi

    if [ "$medicine_person_list_6" == "3" ] || [ "$medicine_person_list_7" == "3" ]; then
        clear
        printf "You have chosen to tell someone about it.\nApparently, some members in your tribe say a mother was kidnapped and that there is a $10,000 reward for the capture of the kidnapper!\nDo you want to go hunt the kidnapper?\n1- Yes; 2- No\nMake your choice $name:\n"
        read -p "" medicine_person_list_11
    fi

    if [ "$medicine_person_list_8" == "1" ]; then
        clear
        printf "You have chosen to die from arrows.\n" + death_level
        read -p "" medicine_person_list_8
        volor_savanna_original
    fi

    if [ "$medicine_person_list_8" == "2" ]; then
        clear
        printf "You have chosen to die from a sword.\n" + death_level
        read -p "" medicine_person_list_8
        volor_savanna_original
    fi

    if [ "$medicine_person_list_8" == "3" ]; then
        clear
        printf "You have chosen to die from a flying lawnmower.\nSeriously though, how do you manage to die from a flying lawnmower?!\nI guess someone strapped jet engines and/or rockets to a lawnmower and it became a flying lawnmower!\n" + death_level
        read -p "" medicine_person_list_8
        volor_savanna_original
    fi

    if [ "$medicine_person_list_8" == "4" ]; then
        clear
        printf "You have chosen to die from a musket.\n" + death_level
        read -p "" medicine_person_list_8
        volor_savanna_original
    fi

    if [ "$medicine_person_list_8" == "5" ]; then
        clear
        printf "You have chosen to die from Bob the Blobfish.\nBob the Blobfish rockets out of his toilet and makes your eyes bleed to death!\n" + death_level
        read -p "" medicine_person_list_8
        volor_savanna_original
    fi

    if [ "$medicine_person_list_9" == "1" ]; then
        clear
        printf "You die from arrows.\n" + death_level
        read -p "" medicine_person_list_9
        volor_savanna_original
    fi

    if [ "$medicine_person_list_9" == "2" ]; then
        clear
        printf "You get stabbed to death by a sword.\n" + death_level
        read -p "" medicine_person_list_9
        volor_savanna_original
    fi

    if [ "$medicine_person_list_9" == "3" ]; then
        clear
        printf "You get stoned to death.\n" + death_level
        read -p "" medicine_person_list_9
        volor_savanna_original
    fi

    if [ "$medicine_person_list_9" == "4" ]; then
        clear
        printf "You get stabbed to death by a knife.\n" + death_level
        read -p "" medicine_person_list_9
        volor_savanna_original
    fi

    if [ "$medicine_person_list_9" == "5" ]; then
        clear
        printf "You are shot to death with a bebe gun.\n" + death_level
        read -p "" medicine_person_list_9
        volor_savanna_original
    fi
    ...
    if [ "$medicine_person_list_10" == "2" ]; then
        clear
        printf "You do not let them settle here.\nUnfortunately, Cooper the Dog hears a doorbell on TV.\nHe goes to bark at the door.\n" + death_level
        read -p "" medicine_person_list_10
        volor_savanna_original
    fi

    if [ "$medicine_person_list_11" == "1" ]; then
        clear
        printf "You hunt the kidnapper.\nDo you capture him?\n1- Find out!\nMake your choice $name:\n"
        read -p "" medicine_person_list_12
    fi

    if [ "$medicine_person_list_11" == "2" ]; then
        clear
        printf "You don't hunt the kidnapper.\nUnfortunately, Zeus comes out from the middle of nowhere and shocks you to death.\nHow shocking!\n" + death_level
        read -p "" medicine_person_list_11
        volor_savanna_original
    fi

    if [ "$medicine_person_list_12" == "1" ] && [ "$rand" == "1" ]; then
        clear
        printf "You don't capture the kidnapper.\nUnfortunately, the kidnapper puts you guys in a trap and kills you.\nYou die.\n" + death_level
        read -p "" medicine_person_list_12
        volor_savanna_original
    fi
