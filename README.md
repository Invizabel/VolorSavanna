...
* Linux DLL: ```gcc VolorSavanna.c -o VolorSavanna.bin -fPIC -shared -Werror -fstack-protector-strong -fstack-protector-all -fstack-clash-protection -D_FORTIFY_SOURCE=2 -fPIE -pie -fno-common -fvisibility=hidden -fno-builtin -fno-plt -pipe -O3```
